...
#SBATCH --jobname="example job" # a nice readable name to give your job so you know what it is when you see it in the queue, instead of just numbers
	...
	srun /home/edoardopedicillo/miniconda3/bin/python3 /home/edoardopedicillo/tesi/gamma_logistic/iterator/quantum_classical_1Dgamma.py --n_epochs=2000 --lr=0.1 --nparams=$SLURM_ARRAY_TASK_ID --iterator=0
