...
def generate_fake_samples(params, latent_dim, samples, circuit, nqubits, layers, hamiltonian1,input=0):
...
def train(d_model, d_model1, latent_dim, layers, nqubits, training_samples, circuit,circuit1, n_epochs, samples, lr, hamiltonian1):
    ...
    for i in range(n_epochs):
        ...
        with tf.GradientTape() as tape1:
            loss1 = define_cost_gan(initial_params1, d_model1, latent_dim, samples, circuit1, nqubits, layers, hamiltonian1)
