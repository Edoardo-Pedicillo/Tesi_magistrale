...
export NUMBA_NUM_THREADS=1
	srun /home/edoardopedicillo/miniconda3/bin/python3 /home/edoardopedicillo/tesi/LHC/quantum-classical_LHCdata_modified.py --n_epochs=6000 --lr=0.1 --n_params=$SLURM_ARRAY_TASK_ID --iterator=3
