...
export NUMBA_NUM_THREADS=1
	srun /home/edoardopedicillo/miniconda3/bin/python3 /home/edoardopedicillo/tesi/LHC/quantum_classical_LHCdata.py --n_epochs=6000 --lr=0.1 --n_params=$SLURM_ARRAY_TASK_ID --iterator=0
