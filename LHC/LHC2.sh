...
export NUMBA_NUM_THREADS=1
	srun /home/edoardopedicillo/miniconda3/bin/python3 /home/edoardopedicillo/tesi/LHC/qc_LHC.py --n_epochs=5000 --lr=0.1 --n_params=$SLURM_ARRAY_TASK_ID --iterator=3
